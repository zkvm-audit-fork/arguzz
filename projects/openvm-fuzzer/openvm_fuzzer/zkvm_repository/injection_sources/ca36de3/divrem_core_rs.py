    ...
    I::Writes: From<[[F; NUM_LIMBS]; 1]>,
{
    ...
    fn execute_instruction(
        ...
        let mut /*INJECTION*/ is_div = divrem_opcode == DivRemOpcode::DIV || divrem_opcode == DivRemOpcode::DIVU;
        let mut /*INJECTION*/ is_signed = divrem_opcode == DivRemOpcode::DIV || divrem_opcode == DivRemOpcode::REM;
